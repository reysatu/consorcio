...
<body>
  ...
  <table style="width: 100%;">
      <tr >
          <td style="border-bottom: 1px dashed black;">DESCRIPCIÓN</td>
          <td style="border-bottom: 1px dashed black;">DOC.</td>
        ...
        <?php 
            ...
            foreach ($venta_detalle as $key => $value) {
                ...
                echo '  <td>'.number_format($value->monto_total, 2).'</td>';
    ...
    <table style="width: 100%;">
        ...
        ?>
        <tr>
            <td style="border-top: 1px dashed black;" colspan="3">TOTAL ABONADO</td>
            <td style="border-top: 1px dashed black;" colspan="1"><?php echo number_format($total, 2); ?></td>  
        </tr>
    </table>
    <br>
