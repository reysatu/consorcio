...
class Product extends Model
{
    ...
    protected $fillable = ['description', 'description_detail', 'state', 'type_id', 'um_id', 'um_quantity', 'model',
        ...
        'average_cost',
        'user_created', 'user_updated', 'user_deleted','idModelo','idCategoria','idFamilia','idSubFamilia','idGrupoContableCabecera','impuesto','motor','chasis','anio_modelo','anio_fabricacion','idMarca','color','disponible_venta','costo'];
