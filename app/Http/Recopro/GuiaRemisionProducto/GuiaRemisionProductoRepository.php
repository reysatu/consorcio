...
namespace App\Http\Recopro\GuiaRemisionProducto;
use Illuminate\Support\Facades\DB;

class GuiaRemisionProductoRepository implements GuiaRemisionProductoInterface
{
    protected $model;
 private static $_ACTIVE = 'A';
    public function __construct(GuiaRemisionProducto $model)
    {
        $this->model = $model; 
