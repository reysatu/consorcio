...
class Customer extends Model
{
    ...
    protected $fillable = ['tipodoc', 'id','documento','razonsocial_cliente','contacto','direccion','correo_electronico','celular','id_tipocli','telefono','ubigeo','cIdUsuCre','cIdUsuMod','IdTipoDocumento'];
