...
namespace App\Http\Recopro\ConfigJerarquiaDetalle;
use Illuminate\Support\Facades\DB;

class ConfigJerarquiaDetalleRepository implements ConfigJerarquiaDetalleInterface
{
    protected $model;
 private static $_ACTIVE = 'A';
    public function __construct(ConfigJerarquiaDetalle $model)
    {
        $this->model = $model; 
