...
//        $this->middleware('json');
    ...
    public function all(Request $request, Query_stockInterface $repo)
    {
        ...
        $params = ['code_article','id','Articulo','Categoria','Unidad','Almacen','Localizacion','Lote','Serie','Disponible','Remitido','Total','Transito','Costo_Promedio_Unitario','Costo_Total'];
