...
$filename='99999999999-08-BD01-00000001.json'; //nombre del archivo txt formato [99999999999]-[99]-[A000]-99999999.txt
$pathRoot='C:/Users/Javier/Documents/app/XXX/20190919/'; //directorio local donde se generan los txt desde el sistema en PHP


$username='99999999999XXXXXXXX'; //RUC del emisor y usuario Sol concatenado
$password='xxxxxxxx'; //clave sol
$contentfile=base64_encode(file_get_contents($pathRoot.$filename));
$parametros = array('fileName'=>$filename,'contentFile'=>$contentfile);
$respuesta=$cliente->call("sendBill",$parametros,'http://service.sunat.gob.pe','',get_header($username, $password));
