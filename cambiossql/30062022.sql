...
(22,'https://e-factura.tuscomprobantes.pe/wsseencpe/billService?wsdl','URL CPE FE',1,FORMAT(GetDate(), 'yyyy-MM-dd hh:mm:ss.000'),1,FORMAT(GetDate(), 'yyyy-MM-dd hh:mm:ss.000'),null,null),
