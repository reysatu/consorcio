...
function create_pdf_ordenServicio(response) {
    ...
    var docDefinition = {
           ...
           content: [
        {
            ...
            fontSize: 14,
             bold: true,
            absolutePosition: { x:560 , y: 64 }
        },
        {
            text: 'X',
            fontSize: 14,
            bold: true,
            absolutePosition: { x:mcondicionPago , y: 77 }
        },
        {
            // Fecha superior
            text: fechRecep,
            bold: true,
            fontSize: 10,
            absolutePosition: { x:364 , y: 90 }
        },
        {
            //Fecha superior
            text: fechEntrega,
            absolutePosition: { x:364 , y: 102 },
            bold: true,
            fontSize: 10,
        },
         {
            ...
            bold: true,
            fontSize: 10,
            absolutePosition:{ x:172 , y: 930 },
        },
        {
            //fecha inferior
            text: fechEntrega,
            absolutePosition: { x:580 , y: 895 },
            bold: true,
            fontSize: 10,
        },
        {
            //Hora superior
            text:""+horaEnt+"",
            absolutePosition: { x:550 , y: 102 },
            bold: true,
            fontSize: 10,
        },
        {
            text: razonsocial_cliente,
            absolutePosition: { x:107 , y: 150 },
            bold: true,
            fontSize: 10,
        },
        {
            text: ruc,
            absolutePosition: { x:107 , y: 166 },
            bold: true,
            fontSize: 10,
        },
        {
            text: direccion,
            absolutePosition: { x:107 , y: 191 },
            bold: true,
            fontSize: 10,
        },
        {
            text: distrito,
            absolutePosition: { x:107 , y: 211 },
            bold: true,
            fontSize: 10,
        },
        {
        ...
        {
            text: dni,
            absolutePosition: { x:81 , y: 253 },
            bold: true,
            fontSize: 10,
        },
        {
            text: telefono,
            absolutePosition: { x:81 , y: 273 },
            bold: true,
            fontSize: 10,
        },
        {
        ...
        },
        {
            //Tipo de servicio
            text: valorSer,
            absolutePosition: { x:311 , y: tipoSer },
            bold: true,
            fontSize: 14,
        },
        {
            text: modelo,
            absolutePosition: { x:455 , y: 150 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cMotor,
            absolutePosition: { x:470 , y: 166 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cChasis,
            absolutePosition: { x:470 , y: 191 },
            bold: true,
            fontSize: 10,
        },
         {
            text: iAnioFab,
            absolutePosition: { x:470 , y: 211 },
            bold: true,
            fontSize: 10,
        },
         {
...

        {
            ...
            absolutePosition: { x:51 , y: 318 },
            bold: true,
            fontSize: 14,
        },
         {
            text: cambioAciete_X,
            absolutePosition: { x:51 , y: 336 },
            bold: true,
            fontSize: 14,
        },
         {
            text: reparacioMotor_x,
            absolutePosition: { x:51 , y: 361 },
            bold: true,
            fontSize: 14,
        },
         {
            text: descar_x,
            absolutePosition: { x:51 , y: 386 },
            bold: true,
            fontSize: 14,
        },
         {
            text: embrague_x,
            absolutePosition: { x:51 , y: 411 },
            bold: true,
            fontSize: 14,
        },
         {
            text: transmi_x,
            absolutePosition: { x:51 , y: 436 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sisArras_x,
            absolutePosition: { x:51 , y: 461 },
            bold: true,
            fontSize: 14,
        },
         {
            text: fren_x,
            absolutePosition: { x:51 , y: 486 },
            bold: true,
            fontSize: 14,
        },
         ...
         {
            text: bate_x,
            absolutePosition: { x:177 , y: 318 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitE_x,
            absolutePosition: { x:177 , y: 336 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitIN_x,
            absolutePosition: { x:177 , y: 361 },
            bold: true,
            fontSize: 14,
        },
         {
            text: suspencio_x,
            absolutePosition: { x:177 , y: 386 },
            bold: true,
            fontSize: 14,
        },
         {
            text: aroneu_x,
            absolutePosition: { x:177 , y: 411 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistEsca_x,
            absolutePosition: { x:177 , y: 436 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistDirecc_x,
            absolutePosition: { x:177 , y: 461 },
            bold: true,
            fontSize: 14,
        },
         {
            text: otro_x,
            absolutePosition: { x:177 , y: 486 },
            bold: true,
            fontSize: 14,
        },
...

        {
         ...
         {
            text: mo_mecanica,
            absolutePosition: { x:512 , y: 334 },
            bold: true,
            fontSize: 10,
        },
        {
            text: terceros,
            absolutePosition: { x:512 , y: 351 },
            bold: true,
            fontSize: 10,
        },
         {
            text: otros_mo,
            absolutePosition: { x:512 , y: 371 },
            bold: true,
            fontSize: 10,
        },
        {
         ...
         {
            text: respuestos,
            absolutePosition: { x:512 , y: 406 },
            bold: true,
            fontSize: 10,
        },
        {
            text: accesorios,
            absolutePosition: { x:512 , y: 426 },
            bold: true,
            fontSize: 10,
        },
         {
        ...
        },
        {
         ...
         {
            text: sub_re,
            absolutePosition: { x:512 , y: 495 },
            bold: true,
            fontSize: 10,
        },
        {
            text: total,
            absolutePosition: { x:512 , y: 511 },
            bold: true,
            fontSize: 10,
        },
        {
         ...
         {
            text: modelo ,
            absolutePosition: { x:391 , y: 678 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cPlacaVeh,
            absolutePosition: { x:553 , y: 678 },
            bold: true,
            fontSize: 10,
        },
