...
function create_pdf_ordenServicio(response) {
    ...
    var docDefinition = {
        ...
        },
        {
            ...
            bold: true,
            fontSize: 10,
            absolutePosition: { x:364 , y: 78 }
        },
        {
            //Fecha superior
            text: fechEntrega,
            absolutePosition: { x:364 , y: 92 },
            bold: true,
            fontSize: 10,
        },
         /* {
        ...
        {
            text: distrito,
            absolutePosition: { x:107 , y: 192 },
            bold: true,
            fontSize: 10,
        },
        {
            text: razonsocial_cliente,
            absolutePosition: { x:107 , y: 209 },
            bold: true,
            fontSize: 10,
        },
        {
            text: dni,
            absolutePosition: { x:81 , y: 232 },
            bold: true,
            fontSize: 10,
        },
        {
            text: correo_electronico,
            absolutePosition: { x:172 , y: 232 },
            bold: true,
            fontSize: 10,
        },
        {
            text: telefono,
            absolutePosition: { x:81 , y: 254 },
            bold: true,
            fontSize: 10,
        },
        {
            text: celular,
            absolutePosition: { x:172 , y: 254 },
            bold: true,
            fontSize: 10,
        },
        {
        ...
        },
        {
         ...
         {
            text: iAnioFab,
            absolutePosition: { x:473 , y: 192 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cColor,
            absolutePosition: { x:443 , y: 209 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cPlacaVeh,
            absolutePosition: { x:443 , y: 232 },
            bold: true,
            fontSize: 10,
        },
         {
            text: nKilometraje,
            absolutePosition: { x:473 , y: 254 },
            bold: true,
            fontSize: 10,
        },

        {
            ...
            absolutePosition: { x:51 , y: 289 },
            bold: true,
            fontSize: 14,
        },
         {
            text: cambioAciete_X,
            absolutePosition: { x:51 , y: 307 },
            bold: true,
            fontSize: 14,
        },
         {
            text: reparacioMotor_x,
            absolutePosition: { x:51 , y: 332 },
            bold: true,
            fontSize: 14,
        },
         {
            text: descar_x,
            absolutePosition: { x:51 , y: 357 },
            bold: true,
            fontSize: 14,
        },
         {
            text: embrague_x,
            absolutePosition: { x:51 , y: 382 },
            bold: true,
            fontSize: 14,
        },
         {
            text: transmi_x,
            absolutePosition: { x:51 , y: 407 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sisArras_x,
            absolutePosition: { x:51 , y: 432 },
            bold: true,
            fontSize: 14,
        },
         {
            text: fren_x,
            absolutePosition: { x:51 , y: 457 },
            bold: true,
            fontSize: 14,
        },
         ...
         {
            text: bate_x,
            absolutePosition: { x:177 , y: 289 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitE_x,
            absolutePosition: { x:177 , y: 307 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitIN_x,
            absolutePosition: { x:177 , y: 332 },
            bold: true,
            fontSize: 14,
        },
         {
            text: suspencio_x,
            absolutePosition: { x:177 , y: 357 },
            bold: true,
            fontSize: 14,
        },
         {
            text: aroneu_x,
            absolutePosition: { x:177 , y: 382 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistEsca_x,
            absolutePosition: { x:177 , y: 407 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistDirecc_x,
            absolutePosition: { x:177 , y: 432},
            bold: true,
            fontSize: 14,
        },
         {
            text: otro_x,
            absolutePosition: { x:177 , y: 457 },
            bold: true,
            fontSize: 14,
        },
...

        {
            //Montos de la orden
            text: mo_revision,
            absolutePosition: { x:512 , y: 279 },
            bold: true,
            fontSize: 10,
        },
         {
            text: mo_mecanica,
            absolutePosition: { x:512 , y: 296 },
            bold: true,
            fontSize: 10,
        },
        {
            text: terceros,
            absolutePosition: { x:512 , y: 316 },
            bold: true,
            fontSize: 10,
        },
         {
            text: otros_mo,
            absolutePosition: { x:512 , y: 336 },
            bold: true,
            fontSize: 10,
        },
        {
            text: sub_mo,
            absolutePosition: { x:512 , y: 358 },
            bold: true,
            fontSize: 10,
        },
         {
            text: respuestos,
            absolutePosition: { x:512 , y: 380 },
            bold: true,
            fontSize: 10,
        },
        {
            text: accesorios,
            absolutePosition: { x:512 , y: 394 },
            bold: true,
            fontSize: 10,
        },
         {
        ...
        },
        {
            //
            text: otros_rep,
            absolutePosition: { x:512 , y: 438 },
            bold: true,
            fontSize: 10,
        },
         {
            text: sub_re,
            absolutePosition: { x:512 , y: 463 },
            bold: true,
            fontSize: 10,
        },
        {
            text: total,
            absolutePosition: { x:512 , y: 485 },
            bold: true,
            fontSize: 10,
        },
        {
         ...
         {
            text: modelo ,
            absolutePosition: { x:361 , y: 620 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cPlacaVeh,
            absolutePosition: { x:485 , y: 620 },
            bold: true,
            fontSize: 10,
        },
