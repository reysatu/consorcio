...
function create_pdf_ordenServicio(response) {
    ...
    var docDefinition = {
        ...
        },
        {
            ...
            bold: true,
            fontSize: 10,
            absolutePosition: { x:364 , y: 74 }
        },
        {
            //Fecha superior
            text: fechEntrega,
            absolutePosition: { x:364 , y: 88 },
            bold: true,
            fontSize: 10,
        },
         /* {
...

        {
            ...
            absolutePosition: { x:56 , y: 279 },
            bold: true,
            fontSize: 14,
        },
         {
            text: cambioAciete_X,
            absolutePosition: { x:56 , y: 297 },
            bold: true,
            fontSize: 14,
        },
         {
            text: reparacioMotor_x,
            absolutePosition: { x:56 , y: 322 },
            bold: true,
            fontSize: 14,
        },
         {
            text: descar_x,
            absolutePosition: { x:56 , y: 350 },
            bold: true,
            fontSize: 14,
        },
         {
            text: embrague_x,
            absolutePosition: { x:56 , y: 372 },
            bold: true,
            fontSize: 14,
        },
         {
            text: transmi_x,
            absolutePosition: { x:56 , y: 397 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sisArras_x,
            absolutePosition: { x:56 , y: 422 },
            bold: true,
            fontSize: 14,
        },
         {
            text: fren_x,
            absolutePosition: { x:56 , y: 447 },
            bold: true,
            fontSize: 14,
        },
        ...
        {
            text: sub_mo,
            absolutePosition: { x:512 , y: 342 },
            bold: true,
            fontSize: 10,
        },
         {
            text: respuestos,
            absolutePosition: { x:512 , y: 356 },
            bold: true,
            fontSize: 10,
        },
        {
            text: accesorios,
            absolutePosition: { x:512 , y: 374 },
            bold: true,
            fontSize: 10,
        },
         {
        ...
        },
        {
            //
            text: otros_rep,
            absolutePosition: { x:512 , y: 420 },
            bold: true,
            fontSize: 10,
        },
         {
            text: sub_re,
            absolutePosition: { x:512 , y: 443 },
            bold: true,
            fontSize: 10,
        },
        {
            text: total,
            absolutePosition: { x:512 , y: 465 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cObservaciones ,
            absolutePosition: { x:65 , y: 585 },
            bold: true,
            fontSize: 10,
        },
         {
            text: modelo ,
            absolutePosition: { x:361 , y: 600 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cPlacaVeh,
            absolutePosition: { x:485 , y: 600 },
            bold: true,
            fontSize: 10,
        },
