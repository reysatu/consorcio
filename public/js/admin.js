...
function create_pdf_ordenServicio(response) {
    ...
    var docDefinition = {
        ...
        },
        {
            ...
            fontSize: 12,
            bold: true,
            absolutePosition: { x:mcondicionPago , y: 83 }
        },
        {
            // Fecha superior
            text: fechRecep,
        ...
        {
            text: ruc,
            absolutePosition: { x:107 , y: 180 },
            bold: true,
            fontSize: 10,
        },
        {
            text: direccion,
            absolutePosition: { x:107 , y: 200 },
            bold: true,
            fontSize: 10,
        },
        {
            text: distrito,
            absolutePosition: { x:107 , y: 223 },
            bold: true,
            fontSize: 10,
        },
        {
            text: razonsocial_cliente,
            absolutePosition: { x:107 , y: 240 },
            bold: true,
            fontSize: 10,
        },
        {
            text: dni,
            absolutePosition: { x:81 , y: 263 },
            bold: true,
            fontSize: 10,
        },
        {
            text: correo_electronico,
            absolutePosition: { x:172 , y: 263 },
            bold: true,
            fontSize: 10,
        },
        {
            text: telefono,
            absolutePosition: { x:81 , y: 285 },
            bold: true,
            fontSize: 10,
        },
        {
            text: celular,
            absolutePosition: { x:172 , y: 285 },
            bold: true,
            fontSize: 10,
        },
        {
        ...
        },
        {
         ...
         {
            text: cMotor,
            absolutePosition: { x:473 , y: 180 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cChasis,
            absolutePosition: { x:473 , y: 200 },
            bold: true,
            fontSize: 10,
        },
         {
            text: iAnioFab,
            absolutePosition: { x:473 , y: 223 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cColor,
            absolutePosition: { x:443 , y: 240 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cPlacaVeh,
            absolutePosition: { x:443 , y: 263 },
            bold: true,
            fontSize: 10,
        },
         {
            text: nKilometraje,
            absolutePosition: { x:473 , y: 285 },
            bold: true,
            fontSize: 10,
        },

        {
            ...
            absolutePosition: { x:51 , y: 330 },
            bold: true,
            fontSize: 14,
        },
         {
            text: cambioAciete_X,
            absolutePosition: { x:51 , y: 348 },
            bold: true,
            fontSize: 14,
        },
         {
            text: reparacioMotor_x,
            absolutePosition: { x:51 , y: 373 },
            bold: true,
            fontSize: 14,
        },
         {
            text: descar_x,
            absolutePosition: { x:51 , y: 398 },
            bold: true,
            fontSize: 14,
        },
         {
            text: embrague_x,
            absolutePosition: { x:51 , y: 423 },
            bold: true,
            fontSize: 14,
        },
         {
            text: transmi_x,
            absolutePosition: { x:51 , y: 448 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sisArras_x,
            absolutePosition: { x:51 , y: 473 },
            bold: true,
            fontSize: 14,
        },
         {
            text: fren_x,
            absolutePosition: { x:51 , y: 498 },
            bold: true,
            fontSize: 14,
        },
         ...
         {
            text: bate_x,
            absolutePosition: { x:177 , y: 330 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitE_x,
            absolutePosition: { x:177 , y: 348 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitIN_x,
            absolutePosition: { x:177 , y: 373 },
            bold: true,
            fontSize: 14,
        },
         {
            text: suspencio_x,
            absolutePosition: { x:177 , y: 398 },
            bold: true,
            fontSize: 14,
        },
         {
            text: aroneu_x,
            absolutePosition: { x:177 , y: 423 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistEsca_x,
            absolutePosition: { x:177 , y: 448 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistDirecc_x,
            absolutePosition: { x:177 , y: 473},
            bold: true,
            fontSize: 14,
        },
         {
            text: otro_x,
            absolutePosition: { x:177 , y: 498 },
            bold: true,
            fontSize: 14,
        },
        ...
        {
            text: total,
            absolutePosition: { x:512 , y: 526 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cObservaciones ,
            absolutePosition: { x:60 , y: 626 },
            bold: true,
            fontSize: 10,
        },
         {
