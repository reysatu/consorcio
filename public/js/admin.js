...
function create_pdf_ordenServicio(response) {
    ...
    var docDefinition = {
           ...
           content: [
        {
            ...
            fontSize: 12,
             bold: true,
            absolutePosition: { x:528 , y: 38 } // cambie menos 11
        },
        {
            text: 'X',
            fontSize: 12,
        ...
        },
        {
            ...
            bold: true,
            fontSize: 10,
            absolutePosition: { x:364 , y: 89 }
        },
        {
            //Fecha superior
            text: fechEntrega,
            absolutePosition: { x:364 , y: 103 },
            bold: true,
            fontSize: 10,
        },
         /* {
        ...
        {
            text: direccion,
            absolutePosition: { x:107 , y: 189 },
            bold: true,
            fontSize: 10,
        },
        {
            text: distrito,
            absolutePosition: { x:107 , y: 212 },
            bold: true,
            fontSize: 10,
        },
        {
            text: razonsocial_cliente,
            absolutePosition: { x:107 , y: 229 },
            bold: true,
            fontSize: 10,
        },
        {
            text: dni,
            absolutePosition: { x:81 , y: 252 },
            bold: true,
            fontSize: 10,
        },
        {
            text: correo_electronico,
            absolutePosition: { x:172 , y: 252 },
            bold: true,
            fontSize: 10,
        },
        {
            text: telefono,
            absolutePosition: { x:81 , y: 274 },
            bold: true,
            fontSize: 10,
        },
        {
            text: celular,
            absolutePosition: { x:172 , y: 274 },
            bold: true,
            fontSize: 10,
        },
        {
        ...
        },
        {
         ...
         {
            text: iAnioFab,
            absolutePosition: { x:473 , y: 212 },
            bold: true,
            fontSize: 10,
        },
         {
            text: cColor,
            absolutePosition: { x:443 , y: 229 },
            bold: true,
            fontSize: 10,
        },
         {
...

        {
            ...
            absolutePosition: { x:51 , y: 319 },
            bold: true,
            fontSize: 14,
        },
         {
            text: cambioAciete_X,
            absolutePosition: { x:51 , y: 337 },
            bold: true,
            fontSize: 14,
        },
         {
            text: reparacioMotor_x,
            absolutePosition: { x:51 , y: 362 },
            bold: true,
            fontSize: 14,
        },
         {
            text: descar_x,
            absolutePosition: { x:51 , y: 387 },
            bold: true,
            fontSize: 14,
        },
         {
            text: embrague_x,
            absolutePosition: { x:51 , y: 412 },
            bold: true,
            fontSize: 14,
        },
         {
            text: transmi_x,
            absolutePosition: { x:51 , y: 437 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sisArras_x,
            absolutePosition: { x:51 , y: 462 },
            bold: true,
            fontSize: 14,
        },
         {
            text: fren_x,
            absolutePosition: { x:51 , y: 487 },
            bold: true,
            fontSize: 14,
        },
         ...
         {
            text: bate_x,
            absolutePosition: { x:177 , y: 319 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitE_x,
            absolutePosition: { x:177 , y: 337 },
            bold: true,
            fontSize: 14,
        },
         {
            text: revisitIN_x,
            absolutePosition: { x:177 , y: 362 },
            bold: true,
            fontSize: 14,
        },
         {
            text: suspencio_x,
            absolutePosition: { x:177 , y: 387 },
            bold: true,
            fontSize: 14,
        },
         {
            text: aroneu_x,
            absolutePosition: { x:177 , y: 412 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistEsca_x,
            absolutePosition: { x:177 , y: 437 },
            bold: true,
            fontSize: 14,
        },
         {
            text: sistDirecc_x,
            absolutePosition: { x:177 , y: 462},
            bold: true,
            fontSize: 14,
        },
         {
            text: otro_x,
            absolutePosition: { x:177 , y: 487 },
            bold: true,
            fontSize: 14,
        },
...

        {
            //Montos de la orden
            text: mo_revision,
            absolutePosition: { x:512 , y: 309 },
            bold: true,
            fontSize: 10,
        },
         {
            text: mo_mecanica,
            absolutePosition: { x:512 , y: 326 },
            bold: true,
            fontSize: 10,
        },
        {
            text: terceros,
            absolutePosition: { x:512 , y: 346 },
            bold: true,
            fontSize: 10,
        },
         {
            text: otros_mo,
            absolutePosition: { x:512 , y: 366 },
            bold: true,
            fontSize: 10,
        },
        {
            text: sub_mo,
            absolutePosition: { x:512 , y: 388 },
            bold: true,
            fontSize: 10,
        },
         {
            text: respuestos,
            absolutePosition: { x:512 , y: 410 },
            bold: true,
            fontSize: 10,
        },
        {
            text: accesorios,
            absolutePosition: { x:512 , y: 424 },
            bold: true,
            fontSize: 10,
        },
         {
        ...
        },
        {
            //
            text: otros_rep,
            absolutePosition: { x:512 , y: 468 },
            bold: true,
            fontSize: 10,
        },
         {
            text: sub_re,
            absolutePosition: { x:512 , y: 493 },
            bold: true,
            fontSize: 10,
        },
        {
            text: total,
            absolutePosition: { x:512 , y: 515 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cObservaciones ,
            absolutePosition: { x:60 , y: 615 },
            bold: true,
            fontSize: 10,
        },
         {
            text: modelo ,
            absolutePosition: { x:391 , y: 670 },
            bold: true,
            fontSize: 10,
        },
        {
            text: cPlacaVeh,
            absolutePosition: { x:515 , y: 670 },
            bold: true,
            fontSize: 10,
        },
